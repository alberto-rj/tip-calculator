<div align="center">
  ...
  <p align="center">
    ...
    &nbsp;&nbsp;
    <a href="https://github.com/alberto-rj/tip-calculator/issues">Report an Issue</a>
    &nbsp;&nbsp;
    <a href="https://github.com/alberto-rj/tip-calculator/issues">Suggest a Feature</a>
  </p>
</div>
...
<div align="center">
  ...
  <!-- Status -->
  <a href="#">
    <img src="https://img.shields.io/badge/Status-Completed-00CE80?style=for-the-badge" alt="Project Status - Completed">
  </a> &nbsp;&nbsp;&nbsp;
...
3. [My Role in the Project](#my-role-in-the-project)
4. [Purpose and Objective](#purpose-and-objective)
5. [Highlight](#highlight)
6. [Screenshots](#screenshots)
7. [How to Run the Project Locally](#how-to-run-the-project-locally)
8. [My Process](#my-process)
   - [Planning](#planning)
...
<img src="demo/demo-tablet.png" alt="Tablet demo">
</details>
<br />
<br />
...
3. Open the `index.html` file in your browser: You can either open the file directly in your browser or use a local server like [Live Server](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer) if you're using [Visual Studio Code](https://code.visualstudio.com/).

4. Interact with the app: The app is ready to use! Simply enter the desired values into the fields and calculate the tips.
